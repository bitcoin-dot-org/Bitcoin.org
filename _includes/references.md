...
[msg_compact_block]: /en/developer-reference#term-msg_compact_block "Inventory type in a getdata message requesting a cmpctblock message on the P2P network"
[msg_filtered_block]: /en/developer-reference#term-msg_filtered_block "An alternative to the block header hash data type identifier of an inventory on the P2P network used to request a merkle block"
