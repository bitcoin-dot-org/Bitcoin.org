...
{% include_absolute _data/devdocs/{{ page.lang }}/references/block_chain.md %}

{% include_absolute _data/devdocs/{{ page.lang }}/references/transactions.md %}

{% include_absolute _data/devdocs/{{ page.lang }}/references/wallets.md %}

{% include_absolute _data/devdocs/{{ page.lang }}/references/p2p_networking.md %}
