...
|----------|--------------|---------------------|-------------
| 4        | version      | int32_t             | Transaction version number (note that this is signed); currently version 1 or 2.  Programs creating transactions using newer consensus rules may use higher version numbers. Version 2 means that [BIP 68](https://github.com/bitcoin/bips/blob/master/bip-0068.mediawiki#specification) applies.
